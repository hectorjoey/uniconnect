...
public class TVPayActivity extends AppCompatActivity {
    ...
    String mOperator_id, mProduct_id, mAmount, mDevice_number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tvpay);
        ...
        mDevice_number = getIntent().getStringExtra("device_number");
        ...
        mBtn_pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (util.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(TVPayActivity.this, "Please check your internet connection", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void doPayment() {
        ...
        double doubleAmount = Double.parseDouble(mAmount);
    ...
    private void doChargeCard() {
        ...
        PaystackSdk.chargeCard(this, charge, new Paystack.TransactionCallback() {
            ...
            public void onSuccess(Transaction transaction) {
                ...
                Toast.makeText(TVPayActivity.this, "Payment was successful", Toast.LENGTH_LONG).show();
                ...
                TVPayActivity.this.transaction = transaction;
            }
            ...
            public void onError(Throwable error, Transaction transaction) {
                ...
                if (error instanceof ExpiredAccessCodeException) {
                    TVPayActivity.this.doChargeCard();
                    return;
                }

                // Handle error messages
                if (transaction.getReference() != null) {
                    Toast.makeText(TVPayActivity.this, error.getMessage() != null ? error.getMessage() : "", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(TVPayActivity.this, error.getMessage() != null ? error.getMessage() : "", Toast.LENGTH_LONG).show();
                }
            }
...
//            deviceDetails.put("meter_type", meter_type.toLowerCase());
            deviceDetails.put("device_number", mDevice_number);

            requestParams.put("amount", parsedAmount);
            requestParams.put("product_id", mProduct_id);
            requestParams.put("operator_id", mOperator_id);
//            requestParams.put("beneficiary_msisdn",  beneficiaryMsisdn);
        ...
        AndroidNetworking.post("https://api.blochq.io/v1/bills/payment?bill=television")
